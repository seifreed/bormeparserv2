...
class CARGO:
    ...
    VICEPRESIDENTE_SEGUNDO_JUNTA_DIRECTIVA = (
        "Vicepresidente segundo de la Junta Directiva"
    )
    ...
    MIEMBRO_COMITE_NOMBRAMIENTOS_Y_RETRIBUCIONES = (
        "Miembro del comité de Nombramientos y Retribuciones"  # NyR
    )
    ...
    SECRETARIO_COMITE_NOMBRAMIENTOS_Y_RETRIBUCIONES = (
        "Secretario del comité de Nombramientos y Retribuciones"
    )
    ...
    SECRETARIO_COMISION_AU_CNT = (
        "Secretario de la comisión Au.Cnt."  # Auditoria de cuentas?
    )
    ...
    SECRETARIO_COMISION_EJECUTIVA_NO_CONSEJERO = (
        "Secretario de la comisión ejecutiva no consejero"
    )
    ...
    SECRETARIO_NO_CONSEJERO_COMISION_EJECUTIVA = (
        "Secretario no consejero de la comisión ejecutiva"
    )
    ...
    ME_COMITE_NOMBRAMIENTOS_Y_RETRIBUCIONES = (
        "Me. del comité de Nombramientos y Retribuciones"  # ?
    )
    ...
    VICESECRETARIO_SEGUNDO_JUNTA_DIRECTIVA = (
        "Vicesecretario segundo de la Junta Directiva"
    )
